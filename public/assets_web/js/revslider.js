...
function revslider_showDoubleJqueryError(e) {
    ...
    function a(n, r) {
        ...
        n.find(">ul:first >li").each(function(e) {
            ...
            s.append('<div class="bullet thumb" style="background-color:' + o + ";position:relative;width:" + r.thumbWidth + "px;height:" + r.thumbHeight + "px;background-image:url(" + u + ') !important;background-size:contain;background-position:center center;"></div>');
                ...
                if (l.find("iframe").length > 0 || l.find("video").length > 0) {
                    ...
                    l.find("iframe").each(function() {
                        ...
                        if (l.data("thumbimage") != t && l.data("thumbimage").length > 2 && l.data("autoplay") != true && !i) {
                            ...
                            l.append('<div class="tp-thumb-image" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url(' + l.data("thumbimage") + '); background-size:contain"></div>')
                        }
